...
import java.net.URL;
public class RegisterDuplicateEmailTest {
  ...
  public void registerDuplicateEmail() {
    ...
    driver.findElement(By.id("ap_customer_name")).sendKeys("First Last");
    driver.findElement(By.id("ap_email")).sendKeys("test@email.com");
    ...
    assertThat(driver.getTitle(), is("Amazon Sign In"));
  }
}
