...
import java.net.URL;
public class RegisterValidEmailWrongPassTest {
  ...
  @Test
  public void registerValidEmailWrongPass() {
    driver.get("https://www.amazon.ca/");
    driver.manage().window().setSize(new Dimension(1240, 696));
    {
    ...
    {
      WebElement element = driver.findElement(By.cssSelector(".hm-icon"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).perform();
    }
    ...
    driver.findElement(By.id("ap_email")).sendKeys("notarealemail@email.com");
    driver.findElement(By.cssSelector(".a-button-inner > #continue")).click();
    driver.findElement(By.id("ap_password")).click();
    driver.findElement(By.id("ap_password")).sendKeys("badpassword");
