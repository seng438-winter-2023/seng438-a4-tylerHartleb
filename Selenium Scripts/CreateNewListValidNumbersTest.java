...
import java.net.URL;
public class CreateNewListValidNumbersTest {
  ...
  @Test
  public void createNewListValidNumbers() {
    ...
    driver.findElement(By.id("list-name")).sendKeys("123");
    ...
    assertThat(driver.findElement(By.id("profile-list-name")).getText(), is("123"));
    {
